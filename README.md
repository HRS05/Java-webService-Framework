...
```
<servlet>
<servlet-name>MYWebRock</servlet-name>
<servlet-class>com.my.pack.webrock.MYWebRock</servlet-class>
</servlet>
<servlet-mapping>
<servlet-name>MYWebRock</servlet-name>
...
```
import com.my.pack.webrock.annotations.*;
@Path("/employee")
...
```
import com.my.pack.webrock.annotations.*;
import com.my.pack.webrock.scopes.*;
@Path("/employee")
public class Employee
{
@Path("/view")
...
ss.setAttribute("name","Harsh Sharma");
